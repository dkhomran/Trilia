    ...
    <template id="column">
        <div data-role="column"
            ...
            <form class="flex flex-col w-full gap-1 px-2 mt-2 overflow-hidden text-sm max-h-0">
                <textarea
                    class="w-full px-4 py-2 mb-1 mt-1 bg-white border border-gray-200 shadow cursor-pointer resize-none select-none line-clamp-3 rounded-xl"
            ...
            constructor(board, id, name, cards = []) {
                ...
                for (const cardData of cards) {
                    const card = new Card(
                        ...
                        cardData.name,
                        this.board,
                        cardData.description, // Pass description
                        cardData.priority, // Pass priority
                        cardData.type, // Pass type
                        cardData.type_color,
                        cardData.estimated_end_date, // Add estimatedDate property if available
                    );
                    card.mountTo(this);
                }
            }
