    ...
    <div id="board-background"
        ...
        <section class="flex h-full min-w-full gap-4 p-4">
            ...
            <div onclick="ModalView.show('addCol')"
                class="flex flex-col flex-shrink-0 gap-2 px-4 py-2 transition
                shadow-lg cursor-pointer select-none h-min w-72 rounded-xl
                bg-slate-100 hover:scale-105 hover:relative">
